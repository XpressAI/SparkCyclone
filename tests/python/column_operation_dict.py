...
operations = {
    ...
    '(x+y)': lambda df : df.select(df['float_x'] + df['float_y']),
    '(x-y)': lambda df : df.select(df['float_x'] - df['float_y']),
    '(x*y)': lambda df : df.select(df['float_x'] * df['float_y']),
    '(x/y)': lambda df : df.select(df['float_x'] / df['float_y'])
}
...
aggregate = {
    ...
    'avg' : lambda df : df.agg(F.avg(df['float_x'])), 
    'avg(x+y)' : lambda df : df.agg(F.avg(df['float_y'] + df['float_x'])), 
    ...
    'covar_pop' : lambda df : df.agg(F.covar_pop(df['integer_val'], df['float_x'])), 
    ...
    'sum' : lambda df : df.agg(F.sum(df['float_x'])), 
    'sum(x+y)' : lambda df : df.agg(F.sum(df['float_y'] + df['float_x'])), 
