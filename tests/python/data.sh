...
/opt/spark/bin/spark-submit --master "local[*]" --name generatedata generate_data.py data/XY_doubles -r 1000
/opt/spark/bin/spark-submit --master "local[*]" --name generatedata generate_data.py data/XY_doubles -r 10000
/opt/spark/bin/spark-submit --master "local[*]" --name generatedata generate_data.py data/XY_doubles -r 100000
