...
run_benchmark.py  --outputfile "yarn_test_ve_100K" --ntest 10 \
group_by "data/XY_doubles_R100000_P100_csv" \
...
--conf spark.sql.columnVector.offheap.enabled=true \
run_benchmark.py  --outputfile "yarn_test_cpu_100K" --ntest 10 \
group_by "data/XY_doubles_R100000_P100_csv" \
--list "group_by_avg_x,group_by_avg_x_plus_y"
#--list "avg_x_double,avg_x_plus_y_double,sum_x_double,sum_x_plus_y_double"
