...
def main(args):
    ...
    schema = T.StructType([
        ...
        T.StructField("int_x", T.IntegerType()),
        T.StructField("int_y", T.IntegerType()),
        T.StructField("float_a", T.FloatType()),
        T.StructField("float_b", T.FloatType()),
        T.StructField("int_a", T.IntegerType()),
        T.StructField("int_b", T.IntegerType()),
