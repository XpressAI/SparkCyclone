...
run_benchmark.py  --outputfile "yarn_test_ve_1B_1" --ntest 10 \
...
--conf spark.sql.columnVector.offheap.enabled=true \
run_benchmark.py  --outputfile "yarn_test_cpu_1B" --ntest 10 \
group_by "data/XY_doubles_R1000000000_P100_csv" \
--list "group_by_avg_x,group_by_avg_x_plus_y"
