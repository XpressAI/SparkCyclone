...
time $SPARK_HOME/bin/spark-submit \
    ...
    --jars ../target/scala-2.12/spark-cyclone-sql-plugin-assembly-1.0.2.jar \
    --conf spark.executor.extraClassPath=../target/scala-2.12/spark-cyclone-sql-plugin-assembly-1.0.2.jar \
