  ...
  "AVG((value#14 - 1.0)) is evaluated" in {
    ...
    assert(cGen(testFName,Set("abcd"), Seq(ref), Alias(null, "avy#123 + 51")() -> expr) == {
      List(
        ...
        "output_0_average_count->validityBuffer = output_0_validity_buffer;",
        "output_0_average_sum->validityBuffer = output_0_validity_buffer;",
        "return 0;"
      )
    }.codeLines)
    ...
    assert(
      cGen(
        ...
        List(
          ...
          "unsigned char* output_1_validity_buffer = (unsigned char *) malloc(1 * sizeof(unsigned char));",
          "output_1_validity_buffer[0] = 0;",
          ...
          "output_1_average_count->validityBuffer = output_1_validity_buffer;",
          "output_1_average_sum->validityBuffer = output_1_validity_buffer;",
          "return 0;"
        ).codeLines
    )
  }
