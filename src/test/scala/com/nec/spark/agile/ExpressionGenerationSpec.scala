...
final class ExpressionGenerationSpec extends AnyFreeSpec with BeforeAndAfter with SparkAdditions {
  ...
  "AVG((value#14 - 1.0)) is evaluated" in {
    ...
    assert(cGen(testFName,Set("abcd"), Seq(ref), Alias(null, "avy#123 + 51")() -> expr) == {
      List(
        s"""extern "C" long ${testFName}(non_null_double_vector* input_0, non_null_double_vector* output_0_average_sum, non_null_bigint_vector* output_0_average_count) {""",
  ...
  "AVG((value#14 + value#13)) is evaluated" in {
    ...
    assert(cGen(testFName, Set("abcd", "abcd_2"), Seq(ref1, ref2), Alias(null, "avy#123 + avy#124")() -> expr) == {
      List(
        s"""extern "C" long ${testFName}(non_null_double_vector* input_0, non_null_double_vector* input_1, non_null_double_vector* output_0_average_sum, non_null_bigint_vector* output_0_average_count) {""",
        "output_0_average_sum->data = (double *)malloc(1 * sizeof(double));",
        "output_0_average_sum->count = 1;",
        "output_0_average_count->data = (long *)malloc(1 * sizeof(long));",
        "output_0_average_count->count = 1;",
  ...
  "SUM((value#14 - 1.0)), AVG((value#14 - 1.0)) is evaluated" in {
    ...
    assert(
      cGen(
        ...
        List(
          s"""extern "C" long ${testFName}(non_null_double_vector* input_0, non_null_double_vector* output_0_sum, non_null_double_vector* output_1_average_sum, non_null_bigint_vector* output_1_average_count) {""",
          "output_0_sum->data = (double *)malloc(1 * sizeof(double));",
          "output_0_sum->count = 1;",
          "double summy_accumulated = 0;",
  ...
  "Sorting" in {
    assert(
      cGenSort(
        ...
        "indices[i] = i;",
        "}",
        "frovedis::radix_sort(input_0->data, indices, input_0->count);",
        "long output_0_count = input_0->count;",
        "double *output_0_data = (double*) malloc(output_0_count * sizeof(double));",
        ...
        "output_1_data[i] = input_1->data[indices[i]];",
        "}",
        "output_0->count = output_0_count;",
        "output_0->data = output_0_data;",
