...
namespace cyclone::tests {
  TEST_SUITE("cyclone::bitset") {
    TEST_CASE("bitmask_to_matching_ids() works") {
      ...
      CHECK(cyclone::bitset::bitmask_to_matching_ids(bitmask) == expected);
    }
    ...
    TEST_CASE("Appending bitset to empty memory works") {
      ...
      cyclone::bitset::append_bitsets(output, 0, b, 8 * 3 * sizeof(uint64_t));
    ...
    TEST_CASE("Merging two uint64_t aligned bitsets works") {
      ...
      cyclone::bitset::append_bitsets(output, 0, a, 8 * 2 * sizeof(uint64_t));
      cyclone::bitset::append_bitsets(output, 8 * 2 * sizeof(uint64_t), b, 8 * 3 * sizeof(uint64_t));
  ...
  //    from b[2] ^ from b[1]
      ...
      cyclone::bitset::append_bitsets(output, 0, a, 2 * 64 + 58);
      cyclone::bitset::append_bitsets(output, 2 * 64 + 58, b, 134);
  ...
  //    from b[2] ^ from b[1]
      ...
      cyclone::bitset::append_bitsets(output, 0, a, 2 * 64 + 58);
      cyclone::bitset::append_bitsets(output, 2 * 64 + 58, b, 132);
  ...
  //           ^ valid until here
      ...
      cyclone::bitset::append_bitsets(output,  0, &inputs[0], lengths[0]);
      cyclone::bitset::append_bitsets(output, lengths[0], &inputs[1], lengths[1]);
      cyclone::bitset::append_bitsets(output, lengths[0] + lengths[1], &inputs[2], lengths[2]);
