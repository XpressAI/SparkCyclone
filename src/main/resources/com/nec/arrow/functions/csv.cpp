                            ...
                            non_null_double_vector* output_c)
{
    ...
    std::string *triples = (std::string *)malloc(sizeof(std::string) * (count * 3));
    ...
    //std::cout << "vector_string_to_words" << std::endl;
    std::vector<std::string> strings;
    strings.assign(triples, triples + (count * 3));
    frovedis::words w = frovedis::vector_string_to_words(strings);
    
    //std::cout << "parsenumber<double>()" << std::endl;
    ...
    //std::cout << "Parsing done. Got " << count << " lines." << std::endl;
